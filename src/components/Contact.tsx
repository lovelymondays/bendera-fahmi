...
const WHATSAPP_NUMBER = '6281234567890'   // Format tanpa + dan tanpa spasi
const EMAIL = 'hello@cetakbenderapro.id'
const ADDRESS = 'Jl. Industri No. 123, Jakarta Utara, DKI Jakarta'
...
export default function Contact() {
  ...
  return (
    <section id="kontak" className="py-24 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="rounded-2xl bg-brand-red p-10 md:p-14 mb-16 relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="font-body text-white/80 text-lg max-w-lg mx-auto mb-8">
              Konsultasi gratis, respon cepat, harga terbaik. Hubungi kami sekarang!
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { icon: MessageCircle, label: 'WhatsApp', value: PHONE, href: waLink },
            { icon: Phone, label: 'Telepon', value: PHONE, href: `tel:${PHONE.replace(/\s/g, '')}` },
            ...
            return (
              ...
              >
                ...
                <div className="font-display font-semibold text-white/60 text-xs mb-1">{c.label}</div>
                <div className="font-body text-white text-sm leading-relaxed">{c.value}</div>
              </a>
            )
          })}
        </div>
        ...
        <div className="mt-5 bg-white/5 border border-white/10 rounded-xl p-5 flex items-center gap-3">
          ...
          <div>
            <span className="font-display font-semibold text-white/60 text-xs">Jam Operasional: </span>
